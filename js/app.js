...
angular.module('ReviewApp', ['ui.bootstrap'])
    .config(function($httpProvider) {
        $httpProvider.defaults.headers.common['X-Parse-Application-Id'] = 'NtPBpqXjxxSiIPn1Rzgf4008f6IeUpDQTJfIRYBR';
        $httpProvider.defaults.headers.common['X-Parse-REST-API-Key'] = 'HSuMRfVo7WTp8FguMi71xbvXBTPh5fCNuAeOKI10';
    })
